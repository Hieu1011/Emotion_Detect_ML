...
emoji_dist = {0: "emojis/angry.png", 2: "emojis/disgust.png", 2: "emojis/fear.png",
              3: "emojis/happy.png", 4: "emojis/neutral.png", 5: "emojis/sad.png", 6: "emojis/surprise.png"}
...
def show_vid():
    ...
    frame1 = cv2.resize(frame1, (700, 500))
...
if __name__ == '__main__':
    root = tk.Tk()
    img = ImageTk.PhotoImage(Image.open("others/logo.png"))
    heading = Label(root, image=img, bg='black')

    heading.pack(ipady=20)
    heading2 = Label(root, text="Photo to Emoji", pady=30, font=('arial', 20, 'bold'), bg='black', fg='#CDCDCD')
